...
| 名称 | 数量 | 重复 | 重合度 |
| ---- | ---- | ---- | ------ |
|  [Global](https://github.com/blackmatrix7/ios_rule_script/tree/master/rule/Loon/Global)    | 842   | [16](https://github.com/blackmatrix7/ios_rule_script/tree/master/rule/Loon/Telegram/Repeat/Global.list)   |   1.90%  |
## 配置说明
