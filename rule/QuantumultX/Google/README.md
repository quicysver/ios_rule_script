...
| 名称 | 数量 | 重复 | 重合度 |
| ---- | ---- | ---- | ------ |
|  [Global](https://github.com/blackmatrix7/ios_rule_bot/tree/master/rule/QuantumultX/Global)    | 848   | 56   |   6.60%  |
## 配置说明
...
https://raw.githubusercontent.com/blackmatrix7/ios_rule_bot/master/rule/QuantumultX/Google/Google.list

稳定版：

https://raw.githubusercontent.com/blackmatrix7/ios_rule_bot/release/rule/QuantumultX/Google/Google.list
...
欢迎通过[issues](https://github.com/blackmatrix7/ios_rule_bot/issues/new)提交反馈，共同完善本项目的Google分流规则。
